        ...
        <a href={urls.live ? urls.live : urls.github}>
          <div className="h-50 w-50 relative group cursor-pointer">
            <img
              ...
              alt={title}
              className="w-50 h-50 rounded-4xl pointer-events-none border-2 border-black/20 dark:border-white/[.2] bg-white dark:bg-white/[.2] shadow-neon-black dark:shadow-neon-white p-2 transition-transform duration-300"
            />
